...
#+INCLUDE:: "load_pkgs.sh" src shell
...
** M4
#+INCLUDE: "install_temptool_m4.sh" src shell
** Ncurses
...
** bzip
#+INCLUDE: "install_final_bzip.sh" src shell 
#+begin_src bash
cd $LFS/sources
LFS_TARGET=bzip
tar -xf $LFS_TARGET*tar*
...
** flit_core
#+INCLUDE: "install_final_flit_core.sh" src shell 
#+begin_src bash
cd $LFS/sources
...
** MarkupSafe
#+INCLUDE: "install_final_markup-safe.sh" src shell 
#+begin_src bash
cd $LFS/sources
...
** jinja
#+INCLUDE: "install_final_jinja.sh" src shell 
#+begin_src bash
cd $LFS/sources
LFS_TARGET=jinja
tar -xf $LFS_TARGET*tar*
